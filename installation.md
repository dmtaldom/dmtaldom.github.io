    ...
    <div class="container">
        <div class="own-hands__inner">
            ...
            <p class="own-hands__text">
                ...
                необходимость использовать мощные наружные антенны типа "Gold Master GM-500", в некоторых случаях, с утановкой их на мачту. 
            </p>
            <p class="own-hands__text">
            ...
            <img class="own-hands__inner-img" src="{{ '/img/dmtaldom_iron_600.png' | relative_url }}" alt="dmtaldom - настройка и установка антенн Дмитров Талдом Дубна с 2010 года">
            <p class="own-hands__text">
